...
window.LLM = (function () {
   ...
   */
  function callLLM(apiKey, model, systemPrompt, userPrompt, jsonMode, baseUrl) {
  ...
  function getRequestInfo(model, baseUrl) {
  ...
  function processChunk(apiKey, model, chunkText, style, baseUrl) {
    ...
    return callLLM(apiKey, model, systemPrompt, userPrompt, true, baseUrl)
  ...
  return {
    process: function (apiKey, model, systemPrompt, userPrompt, baseUrl) {
      return callLLM(apiKey, model, systemPrompt, userPrompt, false, baseUrl);
    },
